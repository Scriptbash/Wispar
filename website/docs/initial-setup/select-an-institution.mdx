...
<img src="/img/docs/app_setup/ezproxy/select_institution.png" alt="Screenshot showing the institution select screen" height="500"/>

1. Tap the <b>Select my institution</b> button.

<img src="/img/docs/app_setup/ezproxy/select_institution_button.png" alt="Screenshot showing a button for selecting an organization" width="300"/>

2. Choose your organization. Use the search bar to quickly filter and find your institution.

<img src="/img/docs/app_setup/ezproxy/proxy_list.png" alt="Screenshot showing the list of available proxies" height="500"/>
