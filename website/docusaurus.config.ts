...
const config: Config = {
  title: 'Wispar',
  tagline: 'Stay up-to-date with academic journals and the latest research articles! ',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Francis Lapointe. Built with Docusaurus.`,
    },
    prism: {
